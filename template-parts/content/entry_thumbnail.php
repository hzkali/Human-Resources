...
?>
	<?php if (has_post_thumbnail()) : ?>
		<div class="consultab-blog-image">
	...
	if (class_exists('ReduxFramework')) {
		...
		if (isset($consultab_option['display_featured_image']) && $consultab_option['display_featured_image'] == 'yes') { ?>

			<div class="consultab-blog-image">
				<?php
				if ('video' === get_post_format() || 'audio' === get_post_format()) {
					echo consultab()->consultab_get_embed_video(get_the_ID());
