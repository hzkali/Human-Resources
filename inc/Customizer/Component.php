<?php
/**
 * Consultab\Utility\Customizer\Component class
 *
 * @package consultab
 */

namespace Consultab\Utility\Customizer;
...
class Component implements Component_Interface {
	...
	public function action_customize_register( WP_Customize_Manager $wp_customize ) {
		...
		$wp_customize->add_section(
			'theme_options',
			array(
				'title'    => __( 'Theme Options', 'consultab' ),
	...
	public function action_enqueue_customize_preview_js() {
		wp_enqueue_script(
			'consultab-customizer',
			get_theme_file_uri( '/assets/js/customizer.min.js' ),
			array( 'jquery' ),
			consultab()->get_asset_version( get_theme_file_path( '/assets/js/customizer.min.js' ) ),
			true
		);
	}
}
