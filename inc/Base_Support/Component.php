<?php
/**
 * Consultab\Utility\Base_Support\Component class
 *
 * @package consultab
 */

namespace Consultab\Utility\Base_Support;
 ...
 * * `consultab()->get_version()`
 * * `consultab()->get_asset_version( string $filepath )`
 */
