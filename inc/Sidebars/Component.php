...
/**
 * Consultab\Utility\Sidebars\Component class
 *
 * @package consultab
 */

namespace Consultab\Utility\Sidebars;
 ...
 * * `consultab()->is_primary_sidebar_active()`
 * * `consultab()->display_primary_sidebar()`
 *
...
class Component implements Component_Interface, Templating_Component_Interface
{
	...
	public function action_register_sidebars()
	{
		register_sidebar(
			array(
				'name' => esc_html__('Blog Sidebar', 'consultab'),
				'id' => static::PRIMARY_SIDEBAR_SLUG,
				'description' => esc_html__('Add widgets here.', 'consultab'),
	...
	{
		$this->get_option =  get_option('consultab-options');
