<?php
/**
 * Consultab\Utility\Nav_Menus\Component class
 *
 * @package consultab
 */

namespace Consultab\Utility\Nav_Menus;
 ...
 * * `consultab()->is_primary_nav_menu_active()`
 * * `consultab()->display_primary_nav_menu( array $args = array() )`
 */
class Component implements Component_Interface, Templating_Component_Interface {
	...
	public function action_register_nav_menus() {
		register_nav_menus(
			array(
				static::PRIMARY_NAV_MENU_SLUG => esc_html__( 'Primary', 'consultab' ),
			)
		);
	}
