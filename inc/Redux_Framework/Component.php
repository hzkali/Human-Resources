...
namespace Consultab\Utility\Redux_Framework;
...
class Component implements Component_Interface {
	...
	protected $opt_name = "consultab-options";
	/**
	...
	public function action_add_redux(){
		...
		$args = array(
			...
			'menu_title'           => esc_html__( 'Consultab','consultab'),
			'page_title'           => esc_html__( 'Consultab','consultab'),
