...
namespace Consultab\Utility\Footer;
...
class Component implements Component_Interface, Templating_Component_Interface
{
	...
	public function register_footers($footer_option)
	{
		...
		$theme_option = get_option('consultab-options');

		$default = [
			'1' => esc_html__('text-left', 'consultab'),
			'2' => esc_html__('text-right', 'consultab'),
			'3' => esc_html__('text-center', 'consultab'),
		];
		...
		foreach ($footer_option as $key => $item) {
			...
			register_sidebar(
				array(
					'name'          => esc_html__('Footer Area ' . $key, 'consultab'),
					'class'         => 'nav-list',
	...
	public function get_footer_option(): array
	{
		...
		if (
			...
			if (class_exists('ReduxFramework')) {
				...
				$options = !empty($consultab_options['consultab_footer_width']) ? $consultab_options['consultab_footer_width'] : '';
				...
				switch ($options) {
					...
					case 3:
						...
						break;
					case 4:
						$data['value'] = ['col-lg-4 col-sm-6 mt-4 mt-lg-0 mt-md-0', 'col-lg-2 col-sm-6 mt-lg-0 mt-4 mt-md-0', 'col-lg-2 col-sm-6 mt-lg-0 mt-4', 'col-lg-4 col-sm-6 mt-lg-0 mt-4'];
						break;
					default:
